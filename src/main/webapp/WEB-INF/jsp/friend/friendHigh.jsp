			...
			<div class="sliderBoxDesc">
				<div id="carouselWrapper" class="description">
					<div class="scrollerBox">
						<ul>
							<li><h5>정의의 안동효까지 온 역사적인 날(feat. 노수)</h5><img src="/images/friend/high_img/myung1.jpg" alt='' width='50px' height='300px'/></li>
							<li><h5>졸업사진 모음</h5><img src="/images/friend/high_img/myung2.jpg"  alt='' width='50px' height='400px'/></li>
							<li><h5>가끔있는 공덕모임</h5><img src="/images/friend/high_img/myung3.jpg"  alt='' width='50px' height='300px'/></li>
							<li><h5>문가오 문피스 이재문 제압</h5><img src="/images/friend/high_img/myung4.jpg"  alt='' width='50px' height='300px'/></li>
							<li><h5>우정 여행</h5><img src="/images/friend/high_img/myung5.jpg"  alt='' width='50px' height='300px'/></li>
						</ul>
					</div>
				</div>
				<div class="sliderNav">
